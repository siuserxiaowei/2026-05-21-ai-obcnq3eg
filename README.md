...
### 中文
2026-05-21 AI 主题会议归档：把飞书纪要整理成静态复盘页，便于浏览、检索和后续整理。

### English
AI-themed meeting archive that turns Feishu minutes into a static review page with discussion context and reference links.
...
- GitHub 仓库 / Repository: https://github.com/siuserxiaowei/2026-05-21-ai-obcnq3eg
- Live / 在线入口：https://siuserxiaowei.github.io/2026-05-21-ai-obcnq3eg/
...
```bash
git clone https://github.com/siuserxiaowei/2026-05-21-ai-obcnq3eg.git
cd 2026-05-21-ai-obcnq3eg
...
- 妙记：https://bytedance.larkoffice.com/minutes/obcnq3eg8i97uoneru8sq726
- 模板：multi_page
- 页面：`docs/index.html`
